// Package debugger provides shared debugging utilities.
package debugger
...
func NewBreakpointManager(chromeCtx context.Context, verbose bool) *BreakpointManager {
...
func (bm *BreakpointManager) setLineBreakpoint(ctx context.Context, bp *Breakpoint) error {
	return chromedp.Run(bm.chromeCtx,
		chromedp.ActionFunc(func(ctx context.Context) error {
			// Parse location to get filename and line
...
func (bm *BreakpointManager) setFunctionBreakpoint(ctx context.Context, bp *Breakpoint) error {
	return chromedp.Run(bm.chromeCtx,
		chromedp.ActionFunc(func(ctx context.Context) error {
			...
			if result.Value != nil {
				// Function exists, inject debugger statement
